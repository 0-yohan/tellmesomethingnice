    ...
    <div>
      ...
      <div className="page2" >
        <div className="letter2">
          ...
          <p className="text2">
            HBD pookie. Happiest birthday to one of the bestest person in this world, to ever exist. You have had me in awe ever since I met you for the 2nd time. You're wonderful and full of surprises. Honestly shawty, you're awesome. You're so badass and wonderful at the same time. The more I start to know about you, the more I  realise how extraordinary you are. You're so thoughyful and non-judgemental at the same time that I can just be so goofy and childish around you without any worries. You're adorable, you're fun, you're someone they'd call a Golden Retriever (even tho idk much about dogs). You're special to me and for many others too, thanks for existing. I'm grateful that your dad didn't use condom on that fateful night. You're someone I'd definitely compete against other guys for. 
           </p>
          <br />
          <p className="text2">
